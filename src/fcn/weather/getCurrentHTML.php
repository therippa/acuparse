...
function getCurrentHTML()
{
    ...
    $next_new_moon = date('n/j @ g:iA', $moon->next_new_moon());
    $next_full_moon = date('n/j @ g:iA', $moon->next_full_moon());
    $last_new_moon = date('n/j @ g:iA', $moon->new_moon());
    $last_full_moon = date('n/j @ g:iA', $moon->full_moon());
    ...
    if (file_exists(APP_BASE_PATH . '/pub/lib/gpl/moon/moontime.php')) {
        ...
        $moon_rise = gmdate('n/j @ g:iA', $moon_time->moonrise);
        $moon_set = gmdate('n/j @ g:iA', $moon_time->moonset);
    }
    // Get Sun Data
    $zenith = 90 + (50 / 60);
    $offset = date('Z') / 3600;
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <div class="row row_moon_data">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><strong>Next New:</strong> <?= $next_new_moon; ?></li>
                        <li><strong>Next Full:</strong> <?= $next_full_moon; ?></li>
                    </ul>
                </div> <!-- END Moon -->
